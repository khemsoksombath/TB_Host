...
export default function Nav(){
    ...
    const {FSR,setFSR} =useContext(SharedText)
    ...
    return(
        ...
        <div class="Nav flex-grow flex justify-between items-center pl-8 pr-8 pt-2 pb-2 md:pl-4 md:pr-4 ">   
            ...
            <div class="responsive md:hidden flex gap-3">
                <button onClick={handleFSR} class="btn btn-primary full md:hidden flex justify-center items-center"><svg class="w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M8 3V5H4V9H2V3H8ZM2 21V15H4V19H8V21H2ZM22 21H16V19H20V15H22V21ZM22 9H20V5H16V3H22V9Z"></path></svg> </button>
